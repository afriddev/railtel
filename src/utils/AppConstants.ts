...
export const DASHBOARD_CONTENT =
  "Welcome to Railtel excited feautres will come soon....";
...
export const LAST_NAME_ERROR = "Please enter Last Name";
export const GENDER_ERROR = "Please select Gender";
